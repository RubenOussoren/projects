Opal.queue(function(Opal) {/* Generated by Opal 1.7.3 */
  var $klass = Opal.klass, $def = Opal.def, $send = Opal.send, $truthy = Opal.truthy, $rb_lt = Opal.rb_lt, $rb_minus = Opal.rb_minus, $rb_plus = Opal.rb_plus, $hash2 = Opal.hash2, $thrower = Opal.thrower, $nesting = [], $$ = Opal.$r($nesting), nil = Opal.nil, content_script = nil;

  Opal.add_stubs('new,setup_message_listener,each,each_with_index,strip,<,-,length,+,filter_sensitive_information,empty?,<<,nil?,apply_filters,gather_context_and_copy_to_clipboard,extract_context,gsub,attr_reader,load_common_names_from_preload_names,load_common_names_from_js_object,insert,search,union,filter_common_name,filter_email,filter_url,attr_accessor,each_char,downcase,children,[],[]=,is_end_of_word=,is_end_of_word');
  ...
  (function($base, $super, $parent_nesting) {
    ...
    $def(self, '$load_common_names_from_js_object', function $$load_common_names_from_js_object(first_names, last_names) {
      ...
      $send(first_names, 'each', [], function $$4(name){var self = $$4.$$s == null ? this : $$4.$$s;
      ...
      return $send(last_names, 'each', [], function $$5(name){var self = $$5.$$s == null ? this : $$5.$$s;
    ...
    $def(self, '$filter_common_name', function $$filter_common_name(text) {
      ...
      return $send(text, 'gsub', [/\b[a-zA-Z]+\b/], function $$6(word){var self = $$6.$$s == null ? this : $$6.$$s;
        if (self.common_last_names_trie == null) self.common_last_names_trie = nil;
        if (self.common_first_names_trie == null) self.common_first_names_trie = nil;
  ...
  (function($base, $super, $parent_nesting) {
    ...
    $def(self, '$insert', function $$insert(word) {
      ...
      node = self.root;
      $send(word.$downcase(), 'each_char', [], function $$7(char$){var $logical_op_recvr_tmp_1 = nil, $ret_or_1 = nil;
    ...
    return $def(self, '$search', function $$search(word) {try { var $t_return = $thrower('return'); 
      ...
      node = self.root;
      $send(word.$downcase(), 'each_char', [], function $$8(char$){
