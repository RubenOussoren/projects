Opal.queue(function(Opal) {/* Generated by Opal 1.7.3 */
  ...
  (function($base, $super, $parent_nesting) {
    ...
    $def(self, '$extract_internal_context', function $$extract_internal_context() {
      ...
      notes = [];
      omni_log_elements = Array.from(document.querySelectorAll('[data-test-id="omni-log-message-content"]'));
      $send(omni_log_elements, 'each', [], function $$3(omni_log_element){var self = $$3.$$s == null ? this : $$3.$$s, closest_article = nil, note = nil, content_elements = nil, filtered_note = nil;

        
        if (omni_log_element == null) omni_log_element = nil;
        closest_article = omni_log_element.closest('article');
        if (($truthy(closest_article.querySelector('[data-test-id="omni-log-internal-note-tag"]')) || ($truthy(closest_article.querySelector('.sc-5rafq2-0.sc-7uf44v-0.kCZlHh'))))) {
    ...
    $def(self, '$extract_public_context', function $$extract_public_context() {
      ...
      notes = [];
      omni_log_elements = Array.from(document.querySelectorAll('[data-test-id="omni-log-message-content"]'));
      $send(omni_log_elements, 'each', [], function $$5(omni_log_element){var self = $$5.$$s == null ? this : $$5.$$s, closest_article = nil, note = nil, content_elements = nil, filtered_note = nil;
