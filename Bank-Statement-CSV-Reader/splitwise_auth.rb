...
class SplitwiseAuth
  ...
  def get_expenses(since_date = nil, until_date = nil, page = 1, per_page = 1000)
    expenses = []
    more_expenses = true
    previous_expense_ids = nil

    while more_expenses
      uri = construct_expenses_uri(per_page, page, since_date, until_date)
  ...
  def construct_expenses_uri(limit, page, since_date, until_date)
    ...
    query_params[:dated_before] = until_date.to_s if until_date
