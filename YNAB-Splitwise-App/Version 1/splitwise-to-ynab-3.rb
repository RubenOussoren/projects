...
client_id = ENV['J980wCxLqUei_9mLQi5TRrUlvE8_AdQVPw2d2ybMKis']
client_secret = ENV['NRcFr3fRgEDNjvvwIBfGkRlXL3o_l-7seWM6m7ORCCM']
...
if File.exist?('access_token.yml')
  ...
  authorize_url = client.auth_code.authorize_url(redirect_uri: "#{redirect_uri}?code=")
  ...
  while true
    ...
    if response.code == '200'
      ...
      query_params = CGI.parse(response.body)
